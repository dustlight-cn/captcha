...
public class AliyunSmsSender implements CodeSender<String> {
    ...
    protected String getSignName(Map<String, Object> parameters) {
        String key = (String) parameters.getOrDefault("SIGN_NAME", properties.getDefaultSignName());
        return properties.getSignNames().getOrDefault(key, key);
    }

    protected String getTemplateCode(Map<String, Object> parameters) {
        String key = (String) parameters.getOrDefault("TEMPLATE_CODE", properties.getDefaultTemplateCode());
        return properties.getTemplateCodes().getOrDefault(key, key);
    }
